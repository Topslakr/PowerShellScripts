...
Write-Host "Removing User from Shared Mailbox"
Remove-MailboxPermission -Identity $SharedMailboxIdentity -user $UserToAdd -AccessRights FullAccess

#Pausing 30 Seconds for Updates to be reflected Online
Write-Host "Pausing 30 Seconds for Change to Be reflected Online"
